...
export default function Plataforma() {
  return (
    <Layout title="Plataforma">
      <Head>
        <title>Plataforma - Funnelever</title>
        <meta name="description" content="Plataforma" />
        <link rel="icon" href="/src/images/favicon.png" />
      </Head>
      <div className={styles.contentCardPlataforma}>
        <Card className={styles.cardPlataformaPrincipal} status="Primary">
          <CardHeader
            style={{
              fontSize: '1.7rem',
              fontWeight: 'normal',
        ...
        <div className={styles.contentCards}>
          <Card className={styles.cardsPlataforma}>
